(function (v, w) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = w() : "function" === typeof define && define.amd ? define(w) : v.ES6Promise = w()
})(this, function () {
    function v(a) {
    ...
    function S() {
        var a = 0, b = new J(n), c = document.createTextNode("");
    ...
    function X(a, b) {
        b._state === y ? m(a, b._result) : b._state === t ? g(a,
            b._result) : E(b, void 0, function (b) {
            return x(a, b)
        }, function (b) {
            return g(a, b)
        })
    ...
    function N(a, b, c) {
        b.constructor === a.constructor && c === D && b.constructor.resolve === F ? X(a, b) : c === p ? (g(a, p.error), p.error = null) : void 0 === c ? m(a, b) : v(c) ? W(a, b, c) : m(a, b)
    }

    function x(a, b) {
        if (a === b) g(a, new TypeError("You cannot resolve a promise with itself")); else {
            var c = typeof b;
    ...
    function G(a) {
        ...
        if (0 !== b.length) {
            for (var d = void 0, e = void 0, f = a._result, g = 0; g < b.length; g += 3) d = b[g], e = b[g + c], d ? L(c, d, e, f) : e(f);
            a._subscribers.length = 0
        }
    }

    function L(a, b, c, d) {
        var e = v(c), f = void 0, h = void 0, k = void 0, l = void 0;
        if (e) {
            try {
                f = c(d)
            } catch (n) {
    ...
    var H = void 0, P = H = Array.isArray ? Array.isArray : function (a) {
            return "[object Array]" === Object.prototype.toString.call(a)
        }, k = 0, B = void 0,
        I = void 0, l = function (a, b) {
            q[k] = a;
            q[k + 1] = b;
            k += 2;
            2 === k && (I ? I(n) : Q())
        ...
        u = void 0, y = 1, t = 2, p = {error: null}, O = 0, ba = function () {
            function a(a, c) {
                ...
                P(c) ? (this._remaining = this.length = c.length, this._result = Array(this.length), 0 === this.length ? m(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(c), 0 === this._remaining && m(this.promise, this._result))) : g(this.promise, Error("Array Methods must be provided an Array"))
            }
            ...
            a.prototype._eachEntry = function (a, c) {
                var d = this._instanceConstructor, e = d.resolve;
                e === F ? (e = M(a), e === D && a._state !== u ? this._settledAt(a._state, c, a._result) : "function" !== typeof e ? (this._remaining--, this._result[c] = a) : d === h ? (d = new d(r), N(d, a, e), this._willSettleAt(d, c)) : this._willSettleAt(new d(function (c) {
                    return c(a)
                }), c)) : this._willSettleAt(e(a), c)
            };
            ...
            function a(b) {
                ...
                this._subscribers = [];
                if (r !== b) {
                    if ("function" !== typeof b) throw new TypeError("You must pass a resolver function as the first argument to the promise constructor");
                    if (this instanceof a) Z(this, b); else throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");
                }
            }
            ...
            a.prototype["finally"] = function (a) {
                ...
                return v(a) ? this.then(function (d) {
