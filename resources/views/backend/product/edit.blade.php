...
@endsection
@section('main')
    <form action="{{ route('admin_product_update', encrypt($data->id)) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mt-4">
                                    <img src="{{asset('upload/product/'.$data->front_image)}}" alt="" style="width: 100px;height: 100px;">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-4">
                                    @foreach($data->images as $image)
                                        <img src="{{asset('upload/product/'.$image->image)}}" alt="" style="width: 100px;height: 100px;">
                                        <a href="{{ route('admin_product_destroyImage', encrypt($image->id)) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i></a>
                                    @endforeach
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <select name="category_id" class="form-control" id="" >
                                                ...
                                                @foreach($categories->where('id', '!=', $data->category_id) as $category)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="short_notes_ar" class="form-control" rows="10">{{$data->getTranslation('short_notes', 'ar')}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                            ...
                                            <div class="tab-pane p-3" id="profile2" role="tabpanel">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="formrow-firstname-input">وصف قصير</label>
                                                            <textarea name="short_notes" class="form-control" rows="10" >{{$data->getTranslation('short_notes', 'en')}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
