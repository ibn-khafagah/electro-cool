...
class TeamDatatable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('image', function($data) {
                return !is_null($data->image)
                    ? '<img src="' . asset('upload/team/' . $data->image) . '" style="width:40px;height:40px;border-radius:50%;" />'
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('job', 'job')->title('المسمى الوظيفي')->responsivePriority(0)->addClass('text-center'),
